...
class UNetExperiment:
    ...
    def train(self):
        ...
        for i, batch in enumerate(self.train_loader):
            ...
            # ANSWER: Variable has dimension batch size X category number X image dimension1 X image dimension2, number means the predcited category each voxel belongs to.
